...
import { resumeStuckLectureProcessing } from "./services/transcodeService.js"
...
httpServer.listen(port, () => {
    ...
    connectDb().then(() => {
        resumeStuckLectureProcessing().catch((err) =>
            console.error("[startup] Failed to resume stuck lecture processing:", err)
        )
    })
})