...
IMPORTANT: Return ONLY the JSON object, no markdown, no code blocks, no additional text. The "questions" array must contain exactly ${numQuestions} items.
`;

        let questionsText = (await groqGenerateContent(prompt, { jsonMode: true })) || '{"questions":[]}';
...
`;
        ...
        let evaluationText = (await groqGenerateContent(prompt, { jsonMode: true })) || "{}";
...
`;
            ...
            let feedbackText = (await groqGenerateContent(feedbackPrompt, { jsonMode: true })) || "{}";
