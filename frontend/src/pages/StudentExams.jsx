                ...
                exams.map((exam) => (
                    ...
                    >
                      ...
                      <div className="h-32 bg-gradient-to-r from-gray-800 to-gray-900 relative overflow-hidden">
                        ...
                        {/* Blurring the thumbnail itself (not just darkening it) is what
                            actually defeats baked-in text: pure opacity/tint alone left
                            bold white lettering ("REACT", etc.) legible even at 80% black,
                            since white blended with black stays high-contrast. Blur removes
                            the sharp edges text needs to be readable at all, regardless of
                            color/contrast. scale-110 + overflow-hidden on the parent hide
                            the blur's soft edge artifacts. */}
                        <div className="absolute inset-0 bg-black/65" />
                        <div className="absolute inset-0 flex flex-col justify-end p-4">
                          <p className="text-white text-sm opacity-90">{exam.course?.title}</p>
