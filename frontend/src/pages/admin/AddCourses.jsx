     ...
     <div className="max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md">
      ...
      <div className="flex items-center justify-center gap-[20px] md:justify-between flex-col md:flex-row mb-6 relative">
        ...
        <div className="space-x-2 space-y-2">
          <button className="bg-black text-white px-4 py-2 rounded-md" onClick={() => navigate(`/createlecture/${courseId}`)}>Go to lectures page</button>
          <button className="bg-blue-600 text-white px-4 py-2 rounded-md" onClick={() => navigate(`/exammanagement/${courseId}`)}>Manage Exams</button>
        </div>
      </div>
