...
function EditLecture() {
  ...
  const editLecture = async () => {
    ...
    try {
      ...
      if (result.data.processingStatus === 'processing') {
        toast.success("Lecture updated - video is now processing into multiple qualities")
      } else {
      ...
      <div className="w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {selectedLecture?.processingStatus === 'processing' && (
              <div className="mb-2 flex items-center gap-2 text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-md px-3 py-2">
                <ClipLoader size={14} color="#b45309" />
                Processing video into multiple qualities... students won't see this lecture until it's ready.
              </div>
            )}
            {selectedLecture?.processingStatus === 'failed' && (
              <div className="mb-2 text-sm text-red-700 bg-red-50 border border-red-200 rounded-md px-3 py-2">
                Quality processing failed for this video. Upload it again to retry.
              </div>
            )}
