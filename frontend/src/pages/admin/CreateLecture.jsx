            ...
            <div key={index} className="bg-gray-100 rounded-md flex justify-between items-center p-3 text-sm font-medium text-gray-700">
              <span className="flex items-center gap-2">
                ...
                {lecture.processingStatus === 'processing' && (
                  <span className="text-xs font-normal text-amber-700 bg-amber-100 px-2 py-0.5 rounded-full">Processing</span>
                )}
                {lecture.processingStatus === 'failed' && (
                  <span className="text-xs font-normal text-red-700 bg-red-100 px-2 py-0.5 rounded-full">Failed</span>
                )}
              </span>
